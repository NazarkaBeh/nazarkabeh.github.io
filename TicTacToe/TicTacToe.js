...
function reset()
{
  if ( x[0] == 'hero' && x[1] == 'hero' && x[2] == 'hero') {
    result.innerHTML = "You win!";
    document.querySelector(".knopka").style.display = "flex";
  } else if ( x[3] == 'hero' && x[4] == 'hero' && x[5] == 'hero') {
    result.innerHTML = "You win!";
    document.querySelector(".knopka").style.display = "flex";
  } else if ( x[6] == 'hero' && x[7] == 'hero' && x[8] == 'hero') {
    result.innerHTML = "You win!";
    document.querySelector(".knopka").style.display = "flex";
  } else if ( x[0] == 'hero' && x[3] == 'hero' && x[6] == 'hero') {
    result.innerHTML = "You win!";
    document.querySelector(".knopka").style.display = "flex";
  } else if ( x[1] == 'hero' && x[4] == 'hero' && x[7] == 'hero') {
    result.innerHTML = "You win!";
    document.querySelector(".knopka").style.display = "flex";
  } else if ( x[2] == 'hero' && x[5] == 'hero' && x[8] == 'hero') {
    result.innerHTML = "You win!";
    document.querySelector(".knopka").style.display = "flex";
  } else if ( x[0] == 'hero' && x[4] == 'hero' && x[8] == 'hero') {
    result.innerHTML = "You win!";
    document.querySelector(".knopka").style.display = "flex";
  } else if ( x[2] == 'hero' && x[4] == 'hero' && x[6] == 'hero') {
    result.innerHTML = "You win!";
    document.querySelector(".knopka").style.display = "flex";
